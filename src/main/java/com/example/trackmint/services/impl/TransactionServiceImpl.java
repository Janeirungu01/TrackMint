...
//
//    @Override
//    public List<TransactionResponse> getTransactionsForCategory(Long userId, Long categoryId) {
//        Category category = categoryRepository.findByUser_Id(categoryId, userId)
//                .orElseThrow(()-> new RuntimeException("Category not found for this user "));
//
//        // Fetch transactions
...
//
//            // Sum amounts
//            return transactionRepository.findByCategory_Id(categoryId).stream()
